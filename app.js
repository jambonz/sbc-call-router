...
assert.ok(process.env.JAMBONES_OUTBOUND_ROUTE, 'missing JAMBONES_OUTBOUND_ROUTE env var');
assert.ok(process.env.JAMBONES_INBOUND_ROUTE, 'missing JAMBONES_INBOUND_ROUTE env var');
